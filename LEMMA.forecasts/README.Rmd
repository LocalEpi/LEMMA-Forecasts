...
This package organizes the functions in **LEMMA-Forecasts** into a package, for easier use in [Shiny application](https://slwu89.shinyapps.io/LEMMA-Shiny/). Please see the vignette for an example of how to use the package.
