...
RunOneCounty <- function(county1, county.dt, county.pop, quick.test) {
  restart.set <- c("Tehama", "Mono", "Yolo", "Yuba", "Mendocino", "Nevada", "El Dorado", "Tuolumne", "Amador", "Inyo", "Calaveras", "Madera", "Humboldt", "Siskiyou", "Butte") #infections went to near zero - restart sim
  ...
  if (quick.test) county.set <- c("Imperial", "Lake", "Madera", "Marin",
  "Mendocino", "Napa", "Nevada", "Placer", "Riverside", "Sacramento",
